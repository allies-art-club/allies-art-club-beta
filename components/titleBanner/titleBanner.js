...
const TitleBanner = (props) => {
  return (
    <TitleWrapper
      $sideSrc1={props.sideSrc1}
      $sideSrc2={props.sideSrc2}
      $centreSrc={props.centreSrc}
    >
      {props.sideSrc1 ? (
        <SideImageWrapper
          $sideSrc1={props.sideSrc1}
        ...
        >
          <SideImage
            $shootingStar={props.shootingStar}
      ...
      >
        ...
        {props.title && props.title.split(": ").length === 2 ? (
          ...
          <BannerTextImg
            ...
            type="image/svg+xml"
            alt={props.svgSrc.alt}
            data={props.svgSrc.src}
          />
        ) : (
          <ImageTitle
            $sideSrc1={props.sideSrc1}
