    ...
    return(
        <Fragment>
            ...
            <Section id="alliesFoundation">
                ...
                <Paragraph>To learn more about AWTFs food bank, you can read our article <Link>Allie's Food Bank</Link>.</Paragraph>
                ...
                <Paragraph>To learn more about the foudners of AWTF and why our club trusts their foundation please view our article <Link>AWTF: A Charity We Can Trust</Link>.</Paragraph>
                <Image src={'/assets/general/heartsR.png'}right={true}/>
            </Section>
        </Fragment>
    )
}
