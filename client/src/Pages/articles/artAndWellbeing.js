...
const ArtAndWellbeing=()=>{
    return(
        <Article>
            ...
            <Section>
                <TextImage alt={"Chalks"} right={false} src={'/assets/articles/artAndWellbeing/artAndWellbeing2.png'}/>
            ...
            <Section>
                <TextImage alt={"Man playing guitar"} right={true} src={"/assets/articles/artAndWellbeing/artAndWellbeing3.png"}/>
            ...
            <Section>
                <TextImage alt="Theatrical expression" right={false} src={'/assets/articles/artAndWellbeing/artAndWellbeing4.png'}/>
            ...
            <Section>
                <TextImage right={true} alt="Art utensils" src={'/assets/articles/artAndWellbeing/artAndWellbeing5.png'}/>
...
Art projects with people dealing with dementia and Alzheimer's disease have also proven the benefits of art for cognitive functioning later in life, showing a significant improvement in participants' memory recall and mental capacities.
            ...
            <Section>
                <TextImage right={false} alt="People dancing" src={"/assets/articles/artAndWellbeing/artAndWellbeing6.png"}/>
                ...
                <Paragraph>Whilst strutting and skipping in a zumba class, kicking and striking in a martial arts contest or stretching and posingin a yoga session, our bodies are given an excellent work-out.</Paragraph>
            ...
            <Section>
                <TextImage right={true} alt="People painting" src={"/assets/articles/artAndWellbeing/artAndWellbeing7.png"}/>
