...
import {Paragraph,TextImage,TextImageTop,Article,ImageWrapper,Floater,Image} from '../../Components/Styled/styled.js';
const WhatIsArt=()=>{
    return(
        <Article>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/whatIsArt/whatIsArt1-small.png 1x, /assets/articles/whatIsArt/whatIsArt1-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/whatIsArt/whatIsArt1-large.png"/>
                    <TextImageTop right={true}src={'/assets/articles/whatIsArt/whatIsArt1-large.png'} alt="Art covering tunnnel walls"/>
                </picture>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/whatIsArt/whatIsArt1-small.png 1x, /assets/articles/whatIsArt/whatIsArt1-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/whatIsArt/whatIsArt1-large.png"/>
                    <TextImageTop mobile={true}src={'/assets/articles/whatIsArt/whatIsArt1-large.png'} alt="Art covering tunnnel walls"/>
                </picture>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/whatIsArt/whatIsArt2-small.png 1x, /assets/articles/whatIsArt/whatIsArt2-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/whatIsArt/whatIsArt2-large.png"/>
                    <TextImage src={'/assets/articles/whatIsArt/whatIsArt2-large.png'} alt="woman on phone"/>
                </picture>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/whatIsArt/whatIsArt3-small.png 1x, /assets/articles/whatIsArt/whatIsArt3-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/whatIsArt/whatIsArt3-large.png"/>
                    <TextImage right={true} src={'/assets/articles/whatIsArt/whatIsArt3-large.png'} alt="Camera shot"/>
                </picture>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/whatIsArt/whatIsArt4-small.png 1x, /assets/articles/whatIsArt/whatIsArt4-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/whatIsArt/whatIsArt4-large.png"/>
                    <TextImage  src={'/assets/articles/whatIsArt/whatIsArt4-large.png'} alt="Heart"/>
                </picture>
