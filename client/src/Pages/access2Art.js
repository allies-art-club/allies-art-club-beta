...
const Access2Art=()=>{
    return (
        <>
            ...
            <Paragraph>If you're interested in donating any arts and crafts supplies or making a financial donation, please head to our <Link>donations page</Link> or donate via our <Link>Crowdfunder</Link> campaign.</Paragraph>
