        ...
        ></TitleBanner>
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing1-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing1-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing1-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing1-large.png'} alt="Child with paint on her hands"/>
                </picture>
            ...
            <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing2-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing2-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing2-large.png"/>
                    <TextImageTop right={false} src={'/assets/articles/artAndWellbeing/artAndWellbeing2-large.png'} alt="Chalks"/>
                </picture>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing2-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing2-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing2-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing2-large.png'} alt="Chalks"/>
                </picture>                
            ...
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing3-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing3-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing3-large.png"/>
                    <TextImageTop right={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing3-large.png'} alt="Man playing guitar"/>
                </picture>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing3-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing3-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing3-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing3-large.png'} alt="Man playing guitar"/>
                </picture>                
            ...
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing4-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing4-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing4-large.png"/>
                    <TextImageTop right={false} src={'/assets/articles/artAndWellbeing/artAndWellbeing4-large.png'} alt="Theatrical expression"/>
                </picture>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing4-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing4-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing4-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing4-large.png'} alt="Theatrical expression"/>
                </picture>                
                <Paragraph>
            ...
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing5-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing5-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing5-large.png"/>
                    <TextImageTop right={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing5-large.png'} alt="Art utensils"/>
                </picture>
...
Art projects with people dealing with dementia and Alzheimer's disease have also proven the benefits of art for cognitive functioning later in life, showing a significant improvement in participants' memory recall and mental capacities.
            ...
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing6-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing6-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing6-large.png"/>
                    <TextImageTop right={false} src={'/assets/articles/artAndWellbeing/artAndWellbeing6-large.png'} alt="People dancing"/>
                </picture>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing6-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing6-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing6-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing6-large.png'} alt="People dancing"/>
                </picture>
<Paragraph>Whilst strutting and skipping in a zumba class, kicking and striking in a martial arts contest or stretching and posing in a yoga session, our bodies are given an excellent work-out.</Paragraph>
            ...
            <Section>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing7-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing7-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing7-large.png"/>
                    <TextImageTop right={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing7-large.png'} alt="People painting"/>
                </picture>
                ...
                <picture>
                    <source media="(max-width: 1024px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing7-small.png 1x, /assets/articles/artAndWellbeing/artAndWellbeing7-2x.png 2x"/>
                    <source media="(min-width: 1025px)" srcSet="/assets/articles/artAndWellbeing/artAndWellbeing7-large.png"/>
                    <TextImageTop mobile={true} src={'/assets/articles/artAndWellbeing/artAndWellbeing7-large.png'} alt="People painting"/>
                </picture>
